let finances = [
  ...
  // Find the total number of elements (length) in the array.
  ...
  // Create a For Loop to determine the total amount over the entire period
  ...
  // Create an If Statement to determine the change in profit and loss 
  ...
  // Create an expression for Average Change
  ...
  console.log(`Greatest increase in profits in ${greatestIncreaseDate}: is ($${greatestIncreaseAmount});`);
  console.log(`Greatest decrease in profits in ${greatestDecreaseDate}: is ($${greatestDecreaseAmount});`);
